    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Customers_Customers_RelatedCustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingDetails", x => new { x.BookingId, x.CustomerId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_RelatedCustomerId",
                table: "Customers",
                column: "RelatedCustomerId",
                unique: true,
                filter: "[RelatedCustomerId] IS NOT NULL");
